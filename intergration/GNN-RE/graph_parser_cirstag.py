...
with open("row_te.txt", "r") as a_file:
  for line in a_file:
    stripped_line = line.strip()
    row_te.append(int(stripped_line))
    connect_te.append(True)

with open("col_te.txt", "r") as a_file:
  for line in a_file:
    stripped_line = line.strip()
    col_te.append(int(stripped_line))
...
if max(row)!=max(row_te):
    col_te.append(max(col))
    row_te.append(max(row))
    connect_te.append(False)
